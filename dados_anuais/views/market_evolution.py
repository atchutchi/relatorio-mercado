...
class MarketEvolutionView(TemplateView):
   ...
   def get_context_data(self, **kwargs):
       ...
       for ano in anos:
           # Obter dados agregados do mercado para cada ano
           dados_totais = DadosAnuais.objects.filter(ano=ano).aggregate(
               ...
               fixa_total=Sum('assinantes_banda_larga_fixa'),
               fixa_256k=Sum('banda_larga_256kbps'),
           ...
           data = {
               ...
               'banda_larga_fixa': {
                   'total': dados_totais['fixa_total'] or 0,
                   '256k': dados_totais['fixa_256k'] or 0,
